...
private:
  ...
  string _phase; //modifica: keeps track of what phase is being simulated
  int _run; //modifica: keeps track of what run we are on
...
public: // Function declarations
  ...
  void ReadPhase();     //modifica: rendere più maneggevole l'input inserendo direttamente la fase da simulare
