...
private:
  ...
  string _sampling;     //Either Gibbs or Metropolis
  ...
  double _global_cv;     //modifica: variabile adeguata per calore specifico
  double _global_cv2;    //modifica
...
bool IsInteger(double a); //ancillary function
